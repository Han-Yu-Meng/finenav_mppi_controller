...
public:
   ...
   */
    void score(CriticData & data,const finenav_mppi_controller::IMapView& map_view) override;
...
protected:
  /**
    ...
    */
    bool inCollision(float cost, const finenav_mppi_controller::IMapView& map_view) const
    {
  ...
  /**
    ...
    */
    float costAtPose(float x, float y, float theta, const finenav_mppi_controller::IMapView& map_view)
    {
