...
protected:
  /**
    ...
    */
    bool inCollision(float x, float y, float theta, const finenav_mppi_controller::IMapView& map_view)
    {
  ...
  /**
    ...
    */
    float costAtPose(float x, float y, const finenav_mppi_controller::IMapView& map_view)
    {
